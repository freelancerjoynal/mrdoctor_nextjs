...
export const DEFAULT_AVATAR = "/images/doctor_avatar.png";

/** Bundled fallback portrait — single global avatar for every profile. */
export function fallbackAvatar(): string {
